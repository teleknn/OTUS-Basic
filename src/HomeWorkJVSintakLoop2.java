...
public class HomeWorkJVSintakLoop2 {
...
//ПЕРВЫЙ ВОПРОС
        ...
        switch (b) {
            case 0:
                question1[b] = "К какому виду операционных систем относиться Linux?";
                System.out.println(question1[b]);
                b++;
            case 1:
                question1[b] = "1 - Монолитное ядро";
                System.out.println(question1[b]);
                b++;
            case 2:
                question1[b] = "2 - Микро ядро";
                System.out.println(question1[b]);
                b++;
            case 3:
                question1[b] = "3 - Гибридное ядро";
                System.out.println(question1[b]);
                b++;
                break;
        }
